...
export default (dnaConfig: DNAIdMappings, conductorUri: string) => {
  ...
  const read = mapZomeFn<ReadParams, Habit>(dnaConfig, conductorUri, HAPP_ID, HAPP_ZOME_NAME_ATOMIC, 'get_habit')
  const readAll = mapZomeFn<null, Habit[]>(dnaConfig, conductorUri, HAPP_ID, HAPP_ZOME_NAME_ATOMIC, 'get_habits')
