    ...
    <FooterContainer>
      ...
      <div className="flex flex-col px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        ...
        <div className="flex justify-around mt-4 space-x-6 socials sm:justify-center md:mt-0">
          <a className="text-primary-900 dark:text-primary-200 hover:text-gray-900 dark:hover:text-white">
            <svg
              className="w-5 h-5"
              fill="currentColor"
              viewBox="0 0 24 24"
          ...
          <a
            href="#"
            className="text-primary-900 dark:text-primary-200 hover:text-gray-900 dark:hover:text-white"
          >
            <svg
              className="w-5 h-5"
              fill="currentColor"
